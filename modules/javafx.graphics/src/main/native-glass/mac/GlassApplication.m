 ...
 */
JNIEXPORT void JNICALL Java_com_sun_glass_ui_Application__1consoleMessage
(JNIEnv *env, jclass jClass, jstring jStr)
{
    NSString *message = [GlassHelper nsStringWithJavaString:jStr withEnv:env];
    NSLog(@"%@", message);
}
