...
class GlassViewEventHandler extends View.EventHandler {
    ...
    {
        System.err.println("KCR: GlassViewEventHandler::handleBeginTouchEvent: "
                + "time = " + time
    ...
    @Override public void handleNextTouchEvent(
            ...
            final int x, final int y, final int xAbs, final int yAbs)
    {
        System.err.println("KCR: GlassViewEventHandler::handleNextTouchEvent: "
                + "time = " + time
                + ", type = " + type
                + ", touchId = " + touchId
                + ", x = " + x
    ...
    @Override public void handleEndTouchEvent(View view, long time) {
        System.err.println("KCR: GlassViewEventHandler::handleEndTouchEvent:"
                + "time = " + time);
        if (PULSE_LOGGING_ENABLED) {
