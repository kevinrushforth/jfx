...
See the API docs for a list of [new APIs](https://download.java.net/java/early_access/javafx25/docs/api/new-list.html) and [deprecated APIs](https://download.java.net/java/early_access/javafx25/docs/api/deprecated-list.html) in each release.

<!-- the API docs for a list of [new APIs](https://openjfx.io/javadoc/25/new-list.html) and [deprecated APIs](https://openjfx.io/javadoc/25/deprecated-list.html) in each release. -->
